...
Bulk Record Upload doesn't use Profiles. Everything it needs is one or more of these four Permission Sets, and a person can hold more than one.
...
| **Bulk Record Upload Previewer** | `Bulk_Record_Upload_Preview_Access` | Review rows before submitting, on a process configured to require preview.                                                |
| **Bulk Record Upload Deletion**  | `Bulk_Record_Upload_Delete_Access`  | Run a Delete process.                                                                                                     |
| **Bulk Record Upload Admin**     | `Bulk_Record_Upload_Administrator`  | Create or edit upload processes and field configuration — this is for the person setting things up, not day-to-day users. |
...
| A Delete process is unavailable to someone who can otherwise use the tool                         | They're missing **Bulk Record Upload Deletion** (`Bulk_Record_Upload_Delete_Access`)                                                                            |
| Someone can't see the preview step on a process that should show one                              | They're missing **Bulk Record Upload Previewer** (`Bulk_Record_Upload_Preview_Access`)                                                                          |
