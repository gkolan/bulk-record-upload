...
- **Try the project with sample data** — follow the [quick start](get-started/quick-start.md) from source installation to two created Accounts.
...
For a guided demonstration, start with [Quick start: upload two sample Accounts](get-started/quick-start.md).
...
- [Plain-language glossary](reference/plain-language-glossary.md) for Salesforce, processing, and
  release terms used across guides, specifications, and evidence records

See [Project status](project-status.md) for release limitations and [Proposed improvements](roadmap.md) for future ideas. The public guides, examples, and checks work without local planning notes or historical reports.
