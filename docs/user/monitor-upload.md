...
| **Failed**                | The upload stopped because of a file, setup, or processing problem. Download the result if one is available; rows completed before the stop can already be saved. |
